...
const Header = () => {
  ...
  return (
    <Navbar
      expand="lg w-100 d-flex justify-content-center"
      variant={theme}
    >
      <Container className="w-75">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            <div
              className={`mode-switcher d-flex justify-content-between align-items-center`}
            >
              dark
              <div
                className={`mode-bg justify-content-${
                  theme === 'light' ? 'end' : 'start'
                }`}
                onClick={toggleTheme}
              >
